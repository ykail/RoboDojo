...
by all synthetic VQA collectors.
"""
...
ANSWER_TYPES = {"point2d", "bbox2d", "boolean", "short_text", "integer"}
VISIBILITY_STATUSES = {
    "not_applicable",
    "visible",
    "partially_visible",
...
def base_record(**overrides: Any) -> dict[str, Any]:
    ...
    record: dict[str, Any] = {
        ...
        "overlay_mark_to_instance_json": None,
        "source_layout": None,
        "scene_id": None,
...
def _parquet_schema():
    ...
    return pa.schema(
        [
            ...
            pa.field("answer_bbox_xyxy_norm", pa.list_(pa.float32())),
            ...
            pa.field("overlay_type", pa.string()),
            pa.field("overlay_version", pa.string()),
            pa.field("overlay_mark_to_instance_json", pa.string()),
